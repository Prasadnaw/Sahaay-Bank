...
window.SahaayVoice = (function(){
  ...
  function handleVoiceInput(transcript) {
    ...
    // FACE LOGIN / SIGN IN WITH FACE VOICE COMMAND
    if (/\b(login with face|face login|sign in with face|face recognition|chehra|face se login)\b/i.test(lower)) {
      window.SahaayFace?.openFaceLoginModal();
      return;
    }
